    ...
    <header className="bg-gray-800 md:sticky top-0 z-10">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <div className="inline-flex items-center border-0 py-1 px-3 mt-4 md:mt-0">
          <a className="mr-5" href="https://github.com/TE109" target="_blank" rel="noopener noreferrer"><Icon circular inverted name='github' /></a>
          <a className="mr-5" href="https://www.linkedin.com/in/tomer-edelman-2b23ab351/" target="_blank" rel="noopener noreferrer"><Icon circular inverted color='blue' name='linkedin' /></a>
        </div>
